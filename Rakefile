...
desc 'Generate documentation for the dynamic_dropdown_menu extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'DynamicDropdownMenuExtension'
...
desc 'Test the dynamic_dropdown_menu extension.'
...
namespace :test do
  desc 'Functional test the dynamic_dropdown_menu extension.'
  ...
  desc 'Unit test the dynamic_dropdown_menu extension.'
